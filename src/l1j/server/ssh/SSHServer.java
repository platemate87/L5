...
public class SSHServer {
	...
	private class ServerThread extends Thread {
		...
		public void run() {
			...
			SimpleGeneratorHostKeyProvider hostKeyGenerator = new SimpleGeneratorHostKeyProvider(
					new File(Config.SSH_HOST_KEY));
			...
			for (String user : users) {
				...
				try {
					for (AuthorizedKeyEntry ake : AuthorizedKeyEntry
							.readAuthorizedKeys(new File(Config.SSH_KEY_FILES_DIRECTORY + user))) {
