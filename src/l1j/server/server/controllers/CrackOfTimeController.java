...
public class CrackOfTimeController extends TimerTask {
	...
	private static final int[][] _crack = { { 32639, 32876, 780 }, { 32794, 32751, 783 } };

	private static final int[][] _cracklocactions = { { 32722, 32688, 4 }, { 32842, 32637, 4 }, { 32861, 32703, 4 },
			{ 32934, 33413, 4 }, { 32970, 33242, 4 }, { 32920, 33160, 4 }, { 34268, 33178, 4 }, { 34243, 33286, 4 },
			{ 34278, 33362, 4 } };
	...
	private void spawnCrack() {
		...
		crack_loc = new L1Location(_cracklocactions[rnd2][0], _cracklocactions[rnd2][1], _cracklocactions[rnd2][2]);
