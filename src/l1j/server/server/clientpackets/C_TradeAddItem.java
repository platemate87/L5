...
public class C_TradeAddItem extends ClientBasePacket {
	...
	private static Logger _log = LoggerFactory.getLogger(C_TradeAddItem.class.getName());
	...
	public C_TradeAddItem(byte abyte0[], Client client) throws Exception {
		...
		if ((!item.isStackable() && itemcount != 1) || item.getCount() <= 0 || itemcount <= 0 || itemcount > 2000000000
