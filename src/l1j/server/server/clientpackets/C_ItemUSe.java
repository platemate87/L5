		...
		if (itemId == 40077 || itemId == SCROLL_OF_ENCHANT_WEAPON || itemId == SCROLL_OF_ENCHANT_QUEST_WEAPON
			...
			if (template.getType() == 0) {
				...
				inventory.removeItem(l1iteminstance, 1);
                                ...
                                L1ItemInstance equipped = pc.getWeapon();
                                if ((target == null || target.get_durability() <= 0)
                                                && equipped != null && equipped.getItem().getType2() != 0
                                                && equipped.get_durability() > 0) {
                                        target = equipped;
                                }
				...
				if (partner_stat) {
					...
					if ((partner.getMapId() == 0 || partner.getMapId() == 4 || partner.getMapId() == 304)
							&& !castle_area && pc.getMap().isEscapable()) {
				...
				if (!Config.USE_PINE_IN_SAFETY && pc.getMap().isSafetyZone(pc.getLocation())) {
