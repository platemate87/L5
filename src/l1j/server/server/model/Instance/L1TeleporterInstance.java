...
public class L1TeleporterInstance extends L1NpcInstance {
	...
	public void onTalkAction(L1PcInstance player) {
		...
		if (talking != null) {
			...
			_log.trace((new StringBuilder()).append("No actions for npc id : ").append(objid).toString());
		}
	}
	...
	public void onFinalAction(L1PcInstance player, String action) {
		...
		if (action.equalsIgnoreCase("teleportURL")) {
			...
			case 50015: {
				...
				break;
			case 50020: {
				price = new String[] { "55", "55", "55", "180", "180", "180", "180", "270", "270", "300", "300", "900",
						"10650" };
			}
				break;
			case 50024: {
				price = new String[] { "55", "55", "55", "55", "198", "55", "132", "264", "55", "198", "264", "220",
						"220", "550", "7480" };
			}
				break;
			case 50036: {
				price = new String[] { "55", "55", "55", "180", "180", "180", "180", "270", "270", "450", "450", "1050",
						"11100" };
			}
				break;
			case 50039: {
				price = new String[] { "55", "55", "180", "180", "270", "270", "270", "360", "360", "600", "600",
						"1200", "11550" };
			}
				break;
			case 50044: {
				price = new String[] { "50", "120", "120", "180", "180", "180", "240", "240", "300", "500", "500",
						"900", "7400" };
			}
				break;
			case 50046: {
				price = new String[] { "50", "120", "120", "120", "180", "180", "180", "240", "300", "500", "500",
						"900", "7400" };
			}
				break;
			case 50051: {
				price = new String[] { "55", "180", "270", "270", "360", "360", "360", "450", "450", "750", "750",
						"1350", "12000" };
			}
				break;
			case 50054: {
				price = new String[] { "55", "55", "55", "180", "180", "270", "270", "360", "450", "300", "300", "750",
						"9750" };
			}
				break;
			case 50056: {
				price = new String[] { "55", "55", "55", "132", "132", "132", "198", "198", "880", "880", "264", "330",
						"330", "880", "7480" };
			}
				break;
			case 50066: {
				price = new String[] { "55", "55", "55", "132", "132", "132", "198", "198", "264", "440", "440", "880",
						"7810" };
			}
				break;
			case 50068: {
			...
			case 50059: {
				...
				break;
			case 50072: {
				price = new String[] { "2200", "1800", "1000", "1600", "2200", "1200", "1300", "2000", "2000", "500",
						"500", "700", "650", "700", "800", "800", "1000" };
			}
				break;
			case 50073: {
				...
				break;
			case 50079: {
				price = new String[] { "550", "550", "600", "550", "700", "600", "600", "750", "750", "500", "500",
						"700", "650", "700", "800", "800", "1000" };
			}
				break;
			case 50080: {
				price = new String[] { "15" };
			...
			case 71080: {
				...
				break;
			case 80132: {
				price = new String[] { "132", "55", "55", "55", "132", "132", "132", "132", "198", "198", "246", "330",
						"330", "770", "7480" };
			}
				break;
			case 80146: {
				price = new String[] { "132", "55", "55", "55", "132", "132", "132", "198", "198", "300", "246", "330",
						"330", "770", "7480" };
			}
				break;
			default: {
		...
		if (action.startsWith("teleport ")) {
			_log.trace((new StringBuilder()).append("Setting action to : ").append(action).toString());
