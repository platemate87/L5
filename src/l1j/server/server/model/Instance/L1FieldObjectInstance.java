...
public class L1FieldObjectInstance extends L1NpcInstance {
	...
	public void onAction(L1PcInstance pc) {
		...
		if (winnersCount == goalCount + 1) {
			...
			// Commented out this line to ensure they get removed at least when the game
			// ends
	...
	private static void checkAddNotify(final L1PcInstance player, final L1ItemInstance item) {
