...
public class HpRegeneration implements Runnable {
	...
	private static Logger _log = LoggerFactory.getLogger(HpRegeneration.class.getName());
	...
	public void regenHp() {
		...
		if (_pc.hasSkillEffect(COOKING_2_4_N) || _pc.hasSkillEffect(COOKING_2_4_S) || _pc.hasSkillEffect(COOKING_3_6_N)
	...
	private boolean isUnderwater(L1PcInstance pc) {
		...
		if (pc.getInventory().checkEquipped(20207) || pc.hasSkillEffect(L1SkillId.STATUS_UNDERWATER_BREATH) || pc.isGm()) {
			return false;
		}
	...
	private boolean isOverWeight(L1PcInstance pc) {
		if (pc.hasSkillEffect(L1SkillId.EXOTIC_VITALIZE) || pc.hasSkillEffect(L1SkillId.ADDITIONAL_FIRE) || pc.getInventory().checkEquipped(20049)) {
			return false;
		}
