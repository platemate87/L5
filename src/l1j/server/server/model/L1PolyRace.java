...
public class L1PolyRace {
	...
	private final int[] polyList = { 936, 3134, 1642, 931, 96, 4038, 929, 1540, 3783, 934, 3918, 3199, 3184, 3132, 3107,
			3188, 3211, 3143, 3156, 3154, 3178, 4133, 5089, 945, 4171, 2541, 2001, 1649, 29, };
	...
	private static final int[][] MANAGER_SPAWN_LOCATIONS = { { 32616, 32778, 4 }, { 32614, 32779, 4 },
			{ 32618, 32779, 4 }, { 32622, 32785, 4 }, { 32610, 32785, 4 }, { 32616, 32719, 4 } };
...
//			}
		...
		case END_STATUS_NOPLAYER:
			for (L1PcInstance pc : playerList) {
				pc.sendPackets(
						new S_SystemMessage(Config.PET_RACE_MIN_PLAYER + " players " + "get ready for the petrace"));
	 ...
	 * @param item4
	 */
	private void fragment(int rnd3, L1PcInstance winner1, L1PcInstance winner2, L1PcInstance winner3,
			L1ItemInstance item4) {
			...
			try {
				for (L1PcInstance pc : playerList) {
					pc.sendPackets(new S_SystemMessage(
							Config.PET_RACE_MIN_PLAYER + " players " + "get ready for the petrace"));
				}
				startCheckTimer();
				this.cancel();
			} catch (Exception e) {
