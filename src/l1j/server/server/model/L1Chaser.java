...
public class L1Chaser implements Runnable {
	...
	public double getDamage(L1PcInstance pc, L1Character cha) {
		...
		damage = (ThreadLocalRandom.current().nextInt(6) + 1 + 7) * coefficientA * coefficientB / 10.5 * coefficientC
				* 2.0;

		damage = L1WeaponSkill.calcDamageReduction(pc, cha, damage, Element.Earth);
