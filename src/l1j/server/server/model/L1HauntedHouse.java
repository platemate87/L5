...
public class L1HauntedHouse {
	...
	private static final int[][] MANAGER_SPAWN_LOCATIONS = { { 32620, 32769, 4 }, { 32628, 32767, 4 },
			{ 32620, 32766, 4 }, { 32623, 32768, 4 } };

	private final List<L1PcInstance> _members = new ArrayList<>();
