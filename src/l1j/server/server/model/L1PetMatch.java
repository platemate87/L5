...
public class L1PetMatch {
	...
	private static final int[][] MANAGER_SPAWN_LOCATIONS = { { 32634, 32738, 4 }, { 32627, 32739, 4 },
			{ 32630, 32738, 4 } };
	...
	private void giveMedal(L1PcInstance pc, int petMatchNo, boolean isWin) {
		...
		L1ItemInstance medals = ItemTable.getInstance().createItem(PETMATCH_MEDAL);
	...
	private void clearPetMatchPlayer(int petMatch, String playerName, String[] names, L1PetInstance[] pets) {
	...
	public class L1PetMatchReadyTimer extends TimerTask {
		private Logger _log = LoggerFactory.getLogger(L1PetMatchReadyTimer.class.getName());
