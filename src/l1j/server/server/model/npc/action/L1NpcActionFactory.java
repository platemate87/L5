...
public class L1NpcActionFactory {
	private static Logger _log = LoggerFactory.getLogger(L1NpcActionFactory.class.getName());
	...
	static {
		try {
			...
			_log.error("L1NpcActionFactory Error when loading Constructors.", e);
		}
	}
	...
	public static L1NpcAction newAction(Element element) {
		try {
			...
			_log.error("L1NpcActionFactory Error when loading actions.", e);
		}
		return null;
	}
}
