...
public class L1Cooking {
	private static final Logger _log = LoggerFactory.getLogger(L1Cooking.class.getName());
	...
	public static void useCookingItem(L1PcInstance pc, L1ItemInstance item) {
		...
		if (itemId >= 41277 && itemId <= 41283 || itemId >= 41285 && itemId <= 41291
				|| itemId >= 49049 && itemId <= 49055 || itemId >= 49057 && itemId <= 49063
				|| itemId >= 49244 && itemId <= 49250 || itemId >= 49252 && itemId <= 49258) {
