...
public class L1MobSkill implements Cloneable {
	...
	/*
	 * 0 -> type of skills do nothing, 1 -> physical attacks, 2 -> magic attack, 3
	 * -> Salmon
	 */
	private int type[];
	...
	/*
	 * Imposition of conditions skills: random probability (0% to 100%) imposition
	 * of skills
	 */
	private int triRnd[];
	 ...
	 * (triRange) following the imposition of TriRange> 0, the distance covered over
	 * when the engine is triRange
	 */
	int triRange[];
	...
	/*
	 * Imposition of conditions skills: Skills triCount following the imposition of
	 * a number of fires
	 */
	...
	/*
	 * If the distance range attacks, physical attacks if the attacks, even if the
	 * proximity to more than 1 set
	 */
	int range[];
	...
	/*
	 * Wide range of attacks, stand-alone if it attacks 0 you, if you attack a range
	 * of zero to set Width and Height setting is an attacker from the width of
	 * Width, Height and depth. Width + - so, do you specify the target, mainly as a
	 * left-right up until the target.
	 */
	int areaWidth[];
	...
	/*
	 * High-range attack in a single attack if 0 you, if you attack a range of more
	 * than 1 set
	 */
	int areaHeight[];
	...
	/*
	 * Damage magnification, 1 / 10, respectively. Physical attacks, magic attacks
	 * both effective
	 */
	int leverage[];
