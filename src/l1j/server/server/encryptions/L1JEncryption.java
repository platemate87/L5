...
public class L1JEncryption {
	...
	private static HashMap<Object, L1JKeys> keyMap = new HashMap<>();

	// The current key to use for encryption/decryption
	// private static LineageKeys currentKeys = null;

	/**
	 * Initializes lineage encrypt/decrypt keys for the given clientID and maps them
	 * to that id.
	 *
	 ...
	 */
	public static L1JKeys initKeys(Object clientID, long seed) throws ClientIdExistsException {
	 ...
	 */
	public static char[] encrypt(char[] buf, L1JKeys currentKeys) throws NoEncryptionKeysSelectedException {
		if (currentKeys == null) {
	 ...
	 * @throws NoEncryptionKeysSelectedException If no keys have been prepared
	 */
	public static byte[] encrypt(byte[] buf, L1JKeys currentKeys) throws NoEncryptionKeysSelectedException {
		if (currentKeys == null) {
			throw new NoEncryptionKeysSelectedException();
		}
	 ...
	 * @throws NoEncryptionKeysSelectedException If no keys have been prepared
	 */
	public static char[] decrypt(char[] buf, L1JKeys currentKeys) throws NoEncryptionKeysSelectedException {
		if (currentKeys == null) {
			throw new NoEncryptionKeysSelectedException();
		}
	 ...
	 * @throws NoEncryptionKeysSelectedException If no keys have been prepared
	 */
	public static byte[] decrypt(byte[] buf, int length, L1JKeys currentKeys) throws NoEncryptionKeysSelectedException {
		if (currentKeys == null) {
			throw new NoEncryptionKeysSelectedException();
		}
