...
public class Client implements Runnable, PacketOutput {
	...
	private ConcurrentLinkedQueue<byte[]> recvqueue = new ConcurrentLinkedQueue<>();
	private ConcurrentLinkedQueue<ServerBasePacket> sendqueue = new ConcurrentLinkedQueue<>();
