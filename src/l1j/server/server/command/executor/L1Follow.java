...
public class L1Follow implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			// TODO: if this gets used more, should probably allow more than 1 person to
			// follow
			if (currentFollower != null) {
				currentFollower.sendPackets(new S_SystemMessage(
						String.format("%s has started following %s. That means you are not anymore.", pc.getName(),
								target.getName())));
			}
