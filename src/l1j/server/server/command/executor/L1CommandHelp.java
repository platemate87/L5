...
public class L1CommandHelp implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		List<L1Command> list = L1Commands.availableCommandList(pc.getAccessLevel().getLevel());
		...
		try {
			...
			if (page > -1) {
				...
				pc.sendPackets(new S_RawStringDialog(pc.getId(), String.format("Available GM Commands (Page %d)", page),
						join(pageList, ", ")));
			} else {
			...
			pc.sendPackets(new S_SystemMessage(
					String.format(".help <page #> or <command_name> -- Currently %d pages.", pages)));
		}
	}
}
