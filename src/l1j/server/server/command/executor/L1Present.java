...
public class L1Present implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			pc.sendPackets(new S_SystemMessage(count + " " + temp.getIdentifiedNameId() + " were given.", true));
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage(".present account itemid enchant amount"));
		}
	}
}
