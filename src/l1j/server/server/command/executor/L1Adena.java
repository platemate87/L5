...
public class L1Adena implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (adena != null) {
				pc.sendPackets(new S_SystemMessage(String.format("%d adena given to %s.", count, char_name)));
			}
		} catch (Exception e) {
			pc.sendPackets(new S_SystemMessage(String.format(".%1$s <amount> or .%1$s <player> <amount>", cmdName)));
		}
	}
}
