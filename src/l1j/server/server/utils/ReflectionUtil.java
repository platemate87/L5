...
public class ReflectionUtil {
	private static Logger _log = LoggerFactory.getLogger(ReflectionUtil.class.getName());
	...
	public static <T, T2> T newInstance(String className, Class<T2> arg, T2 argValue) {
