...
public class LogTradeAddItem {
	private static Logger _log = LoggerFactory.getLogger(LogTradeAddItem.class.getName());

	public void storeLogTradeAddItem(L1PcInstance pc, L1PcInstance target, L1ItemInstance item, int itembefore,
		...
		try {
			...
			pstm = con.prepareStatement(
					"INSERT INTO logtradeadditem VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
			Date time = new Date();
