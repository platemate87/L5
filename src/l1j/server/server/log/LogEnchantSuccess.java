...
public class LogEnchantSuccess {
	private static Logger _log = LoggerFactory.getLogger(LogEnchantSuccess.class.getName());

	public void storeLogEnchantSuccess(L1PcInstance pc, L1ItemInstance item, int oldEnchantLvl, int newEnchantLvl,
			int enchantnum) {
		Connection con = null;
