...
public class LogClanDwarfOut {
	private static Logger _log = LoggerFactory.getLogger(LogClanDwarfOut.class.getName());

	public void storeLogClanDwarfOut(L1PcInstance pc, L1ItemInstance item, int item_count_before, int item_count_after,
			int item_out_count) {
		Connection con = null;
		...
		try {
			...
			pstm = con.prepareStatement(
					"INSERT INTO logclanwarehouseout VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
			Date time = new Date();
