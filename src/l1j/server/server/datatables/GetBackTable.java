...
public class GetBackTable {
	private static Logger _log = LoggerFactory.getLogger(GetBackTable.class.getName());
	private static GetBackTable _instance;
	private final HashMap<Integer, L1GetBack> _getback = new HashMap<>();
	...
	public L1GetBack[] getGetBackRestartTableList() {
		return _getback.values().toArray(new L1GetBack[_getback.size()]);
	}
}
