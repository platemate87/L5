...
public class ChatLogTable {
	...
	/*
	 * HashMap in the code should be used, but the performance problems might have
	 * used an array compromise. HashMap to consider changes to the performance or
	 * the lack of sufficient attention to the problem.
	 */
