...
public class NpcChatTable {
	private final static Logger _log = LoggerFactory.getLogger(NpcChatTable.class.getName());
	private static NpcChatTable _instance;
	private final Map<Integer, L1NpcChat> _npcChatAppearance = new HashMap<>();
	private final Map<Integer, L1NpcChat> _npcChatDead = new HashMap<>();
	private final Map<Integer, L1NpcChat> _npcChatHide = new HashMap<>();
	private final Map<Integer, L1NpcChat> _npcChatGameTime = new HashMap<>();
