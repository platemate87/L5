...
public class WeaponSkillTable {
	private static Logger _log = LoggerFactory.getLogger(WeaponSkillTable.class.getName());
	...
	private void fillWeaponSkillTable(ResultSet rs) throws SQLException {
		while (rs.next()) {
			...
			L1WeaponSkill weaponSkill = new L1WeaponSkill(weaponId, probability, fixDamage, randomDamage, area, skillId,
