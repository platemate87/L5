...
public class AccessLevelTable {
	...
	private final LinkedHashMap<Short, L1AccessLevel> _accessLevels = new LinkedHashMap<>();
	...
	private AccessLevelTable() {
		...
		for (Short accessId : _accessLevels.keySet()) {
			...
			if (lowestAccessLevel == null || currentLevel.getLevel() < lowestAccessLevel.getLevel())
