...
public class S_BookmarkLoad extends ServerBasePacket {
	...
	private final int maxBookmarks = 100; // TODO -- pull from config.. but verify a certain # won't crash the client
											// first
	...
	public S_BookmarkLoad(L1PcInstance pc) {
		...
		try {
			...
			pstm = con.prepareStatement(
					"SELECT * FROM character_teleport WHERE char_id=? ORDER BY REGEXP_REPLACE(name, '\\\\\\\\..', '') ASC");
